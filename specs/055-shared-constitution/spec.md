...
- [ ] AC10: The precedence order — framework as floor, and project > shared > framework where the framework is silent — is stated once in the config-schema documentation, together with the fact that nothing enforces it.
