...
- [x] AC4: govern's domain rule files scaffold to `.agents/rules/<name>.md`
- [x] AC5: gvrn is wired via `.agents/mcp_config.json` (local stdio server, additive)
...
- [x] AC10: The README documents the Antigravity bootstrap (curl the `govern` skill
