...
- [x] AC2: The `/govern` procedure contains no workflow scaffolding: no recommendation flow, no registry manifest row, no `[workflows]` config schema, no workflow prompts in the procedural-fidelity preamble.
