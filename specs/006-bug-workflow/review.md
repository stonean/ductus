...
The scenario file shape is reused by every subsequent spec elaborating against a section (009, 010, 011, 012, 020). The triage/inbox convention threads through `/ductus:groom`, `/ductus:specify`, and `/ductus:log`.
