...
ductus's previously-written `.agents/mcp_config.json` is now inert cruft (agy ignores it):
ductus stops writing it going forward and leaves existing copies in place — no destructive
