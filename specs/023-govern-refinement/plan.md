...
3. **Frozen-archaeology accommodation** — done specs under `specs/NNN-*/` retain their `/ductus:validate` references. A single "Past Renames" note in `specs/README.md` records the change so readers can map old to new without per-spec signposts.
