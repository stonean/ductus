...
- [ ] Re-render the installed commands with `scripts/gen-claude-commands.sh` (the framework source is canonical; `.claude/commands/ductus/` is a build artifact that does not update on its own)
