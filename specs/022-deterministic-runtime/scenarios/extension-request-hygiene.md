...
- `read_existing_section` selects the file by the running command (`/ductus:plan` reads plan.md, `/ductus:specify` reads spec.md), threaded explicitly rather than by fallback order.
