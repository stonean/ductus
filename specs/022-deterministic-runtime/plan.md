...
- **`/ductus:target`** — strict byte-equality on `.govern.session.toml` after the run (single repo-root path post-0.10.0 consolidation; was `.claude/gov-session.json` pre-0.10.0).
