...
| 11 — `rewrite-spec-links` | Idempotent by construction: once re-pointed, no link names the retiring directory, so the second pass rewrites nothing. |
