...
- The recommended next step for a feature with outstanding scenario questions is `/gov:clarify` (scenario-targeted) rather than `/gov:implement` — see the Status → next action table's override below.
